...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    ...
    selectedBrands: function selectedBrandss(value) {
      ...
      if (this.autor != '') {
        ...
        if (this.option != '') {
            if (this.option.includes('+')) {
                this.selectedOptions = this.option.split('+');
            } else {
                this.selectedOptions = [this.option];
            }
        }
