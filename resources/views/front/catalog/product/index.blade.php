        ...
        <ol class="breadcrumb flex-lg-nowrap">
            ...
            @if ($group)
                ...
                @elseif ($cat && $subcat)
                    ...
                    @if ($prod)
                        @if ($cat && ! $subcat)
                            <li class="breadcrumb-item text-nowrap active" aria-current="page"><a class="text-nowrap"
                                                                                                  href="{{ route('catalog.route', ['group' => $group, 'cat' => $cat->translation->slug]) }}">{{ \Illuminate\Support\Str::limit($prod->translation->name, 50) }}</a></li>
                        @else
                            <li class="breadcrumb-item text-nowrap active" aria-current="page"><a class="text-nowrap"
                                                                                                  href="{{ route('catalog.route', ['group' => $group, 'cat' => $cat->translation->slug, 'subcat' => $subcat->translation->slug]) }}">{{ $subcat->translation->title }}</a>
                            </li>
                        @endif
                    @endif
                @endif
            ...
            <div class="h-100 bg-light rounded-3 py-5 px-4 px-sm-5">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <a id="openReview" href="#reviews" data-scroll>
                        ...
                        <span class="d-inline-block fs-sm text-body align-middle mt-1 ms-1">{{ $reviews->count() }} @if($reviews->count() > 1)
                                {{ __('front/ricekakis.reviews') }}
                            @else
                                {{ __('front/ricekakis.review') }}
                            @endif</span>
                    </a>
                </div>
               ...
               <span class="fs-sm text-muted me-1">
                ...
                <div class="accordion mb-4" id="productPanels">
                    <div class="accordion-item">
                        <h3 class="accordion-header"><a class="accordion-button collapsed" href="#productInfo" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="productInfo"><i
                                        class="ci-announcement text-muted fs-lg align-middle mt-n1 me-2"></i> {{ __('front/ricekakis.osnovne_informacije') }}</a></h3>
                    ...
                    <div class="accordion-item">
                        <h3 class="accordion-header"><a class="accordion-button collapsed" href="#shippingOptions" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="shippingOptions"><i
                                        class="ci-delivery text-muted lead align-middle mt-n1 me-2"></i>{{ __('front/ricekakis.opcije_dostave') }}</a></h3>
                                ...
                                @foreach($shipping_methods as $shipping_method)
                                    <div class="d-flex justify-content-between ">
                                        <div>
                                            ...
                                            @if ($shipping_method->code == 'pickup')
                                                <div class="fs-sm text-muted"> {{ $shipping_method->data->short_description->{ current_locale() } }}</div>
                                            @else
                    ...
                    <div class="accordion-item">
                        <h3 class="accordion-header"><a class="accordion-button collapsed" href="#localStore" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="localStore"><i
                                        class="ci-card text-muted fs-lg align-middle mt-n1 me-2"></i>{{ __('front/ricekakis.nacin_placanja') }}</a></h3>
                            ...
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class=" fs-md pb-2 mb-4">
                                    ...
                                    <ul class="list-unstyled fs-sm pb-2">
                                        ...
                                        @endif
                                        @if ($prod->brand)
                                            <li class="d-flex justify-content-between pb-3 pt-2 border-bottom"><span class="fw-bold">Brand:</span> <a
                                                        href="{{ route('catalog.route.brand', ['brand' => $prod->brand->translation->slug]) }}"><span>{{ $prod->brand->title}} </span></a></li>
                                        @endif
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" name="reviews" id="reviews" role="tabpanel">
                        ...
                        <div class="row pt-2 pb-3">
                            <div class="col-lg-4 col-md-5 mb-3">
                                <h4 class="h3 mb-1"> {{ $reviews->count() }} @if($reviews->count() > 1)
                                        {{ __('front/ricekakis.reviews') }}
                                    @else
                                        {{ __('front/ricekakis.review') }}
                                    @endif</h4>
                                ...
                                <span class="d-inline-block align-middle">{{ number_format($reviews->avg('stars'), 2) }} {{ __('front/ricekakis.prosjecna_ocjena') }}  </span>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="w-100">
                                            <div class="progress" style="height: 4px;">
                                                <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $prod->percentreviews($reviews->where('stars', $i)->count(), $reviews->count()) }}%;"
                                                     aria-valuenow="{{ $prod->percentreviews($reviews->where('stars', $i)->count(), $reviews->count()) }}" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
        ...
        <section class="pb-5 mb-2 mb-xl-4">
            ...
            <div class="tns-carousel tns-controls-static tns-controls-outside tns-nav-enabled pt-2">
                <div class="tns-carousel-inner"
                     data-carousel-options="{&quot;items&quot;: 2, &quot;gutter&quot;: 16, &quot;controls&quot;: true, &quot;autoHeight&quot;: true, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:2}, &quot;480&quot;:{&quot;items&quot;:2}, &quot;720&quot;:{&quot;items&quot;:3}, &quot;991&quot;:{&quot;items&quot;:2}, &quot;1140&quot;:{&quot;items&quot;:3}, &quot;1300&quot;:{&quot;items&quot;:4}, &quot;1500&quot;:{&quot;items&quot;:5}}}">
