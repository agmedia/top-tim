<form name="pay" class="needs-validation w-100" action="{{ route('checkout') }}" novalidate method="GET">
    ...
    <div class="w-50 pe-3">
        <a class="btn btn-outline-primary d-block w-100" href="{{ route('naplata') }}"><i class="ci-arrow-left  me-1"></i><span class="d-none d-sm-inline">Povratak na plaćanje</span><span class="d-inline d-sm-none">Povratak</span></a>
    </div>
    <div class="w-50 ps-2">
