        ...
        <div class="px-lg-5 pt-2 pb-4">
            <div class="mx-auto px-3" >
                ...
                <div class="row py-lg-2">
                    ...
                    <p>
                        <img src="{{ asset('media/cards/ESIF.jpg') }}" alt="ESIF" width="120" height="60" style="height:60px;margin-bottom: -8px; margin-left: -5px;" loading="lazy">
                        <img src="{{ asset('media/cards/EUamblem.jpg') }}" alt="EU" width="78" height="60" loading="lazy" style="height:60px;">
                        <img src="{{ asset('media/cards/HAMAG-Bicro-logo-RGB-mali.jpg') }}" width="143" height="30" style="height:30px;margin-top: -8px;" loading="lazy" alt="HAMAG">
                    </p>
