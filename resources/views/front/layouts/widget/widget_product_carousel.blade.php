...
<section class="pt-2">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center pt-1  pb-2 mb-2">
        ...
        @if($data['url'] !='/')
         <a class="btn btn-outline-primary btn-sm btn-shadow mt-3" aria-label="View Offer" href="{{ url($data['url']) }}"><span class="d-none d-sm-inline-block">Pogledajte ponudu</span> <i class="ci-arrow-right "></i></a>
        @endif
