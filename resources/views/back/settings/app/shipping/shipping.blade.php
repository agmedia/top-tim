    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">{{ __('back/app.shipping.title') }}</h1>
            </div>
        </div>
    </div>
    ...
    @include('back.layouts.partials.session')
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">{{ __('back/app.shipping.list') }}</h3>
            </div>
            <div class="block-content">
                <table class="table table-striped table-borderless table-vcenter">
                    <thead class="thead-light">
                    <tr>
                        <th>{{ __('back/app.shipping.input_title') }}</th>
                        <th class="text-center" style="width: 15%;">{{ __('back/app.shipping.sort_order') }}</th>
                        <th class="text-center" style="width: 15%;">{{ __('back/app.shipping.price') }}</th>
                        <th class="text-center" style="width: 15%;">{{ __('back/app.shipping.status_title') }}</th>
                        <th style="width: 10%;" class="text-right">{{ __('back/app.shipping.edit_title') }}</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    @empty
                        <tr class="text-center">
                            <td colspan="4">{{ __('back/app.shipping.empty_list') }}</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
