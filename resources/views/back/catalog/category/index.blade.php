                        ...
                        @forelse($categories as $category)
                            <div class="block block-rounded mb-1">
                                <div class="block-header block-header-default" role="tab" id="accordion_h{{ $category->id }}">
                                    <a class="h3 block-title" data-toggle="collapsed" data-parent="#accordion" href="#accordion_q{{ $category->id }}" aria-expanded=" false" aria-controls="accordion_q{{ $category->id }}">{{ $category->translation->title }}</a>
