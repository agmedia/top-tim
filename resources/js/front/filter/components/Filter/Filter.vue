        ...
        <div class="widget widget-categories " v-if="categories">
            <div class="accordion " id="shop-categories">
                ...
                <div class="accordion-item border-bottom" v-for="cat in categories">
                    ...
                    <h3 class="accordion-header px-grid-gutter bg-default fw-bolder" v-if="category && (category.id == cat.id)" >
                        ...
                        <a :href="cat.url" v-if="!cat.subs" class="nav-link-style d-block fs-md  text-uppercase py-3" :class="{'active': (category.id == cat.id)}" role="link">
                            <span class="d-flex align-items-center "><span v-html="cat.icon"></span> {{ cat.title }} </span>
                        </a>
                    </h3>

                    <h3 class="accordion-header px-grid-gutter fw-bolder" v-else>
                        <button class="accordion-button collapsed py-3" v-if="cat.subs " type="button" data-bs-toggle="collapse" :data-bs-target="'#id' + cat.id" aria-expanded="false" :aria-controls="'id'+ cat.id">
                            <span class="d-flex align-items-center fw-bolder text-uppercase"> {{ cat.title }} </span>
                        </button>
                        <a :href="cat.url" v-if="!cat.subs" class="nav-link-style d-block fs-md  text-uppercase py-3 " role="link">
                            <span class="d-flex align-items-center"><span v-html="cat.icon"></span> {{ cat.title }}</span>
                        </a>
                    </h3>

                    <div class="collapse show" :id="'id'+ cat.id" v-if="cat.subs && category && (category.id == cat.id)" data-bs-parent="#shop-categories">
                        <div class="px-grid-gutter pt-1 mt-2 pb-4">
                    ...
                    <div class="collapse" :id="'id'+ cat.id"  v-else data-bs-parent="#shop-categories">
                        <div class="px-grid-gutter pt-1 pb-4 mt-2">
                            <div class="widget widget-links">
