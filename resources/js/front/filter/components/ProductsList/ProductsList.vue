            ...
            <div class="px-2 mb-4 d-flex align-items-stretch" v-for="product in products.data">
                <div class="card product-card card-static pb-3">
                    ...
                    <div class="card-body py-2 pt-0">
                        ...
                        <div class="product-price">
                            <span class="text-dark fs-md" v-if="!product.main_special">{{ product.main_price_text }} <small v-if="product.secondary_price_text ">{{ product.secondary_price_text }} </small></span>
                        </div>
