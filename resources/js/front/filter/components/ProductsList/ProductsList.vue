                                    ...
                                    <ul class="widget-list widget-filter-list list-unstyled pt-1" style="max-height: 11rem;" data-simplebar data-simplebar-auto-hide="false">
                                        <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="macron">
                                                <label class="form-check-label widget-filter-item-text" for="macron">Macron</label>
                                            </div><span class="fs-xs text-muted">425</span>
                                        </li>
                                        <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="joma">
                                                <label class="form-check-label widget-filter-item-text" for="jomar">Joma</label>
                                            </div><span class="fs-xs text-muted">15</span>
                                        </li>
                                        <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="zeus">
                                                <label class="form-check-label widget-filter-item-text" for="zeus">Zeus</label>
                                            </div><span class="fs-xs text-muted">18</span>
                                        </li>
                                        <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="givova">
                                                <label class="form-check-label widget-filter-item-text" for="givova">Givova</label>
                                            </div><span class="fs-xs text-muted">103</span>
                                        </li>
                                        <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="select">
                                                <label class="form-check-label widget-filter-item-text" for="select">Select</label>
                                            </div><span class="fs-xs text-muted">27</span>
                                        </li>
                                        <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="yakimasport">
                                                <label class="form-check-label widget-filter-item-text" for="yakimasport">Yakimasport</label>
                    ...
                    <div class="card-body py-2 pt-0">
                        ...
                        <div class="star-rating" v-if="product.stars">
                            <span v-for="item in 5 ">
                                ...
                                <i v-else-if="product.stars  > 0 " class="star-rating-icon ci-star"></i>
                            </span>
