<template>
    <div class="navbar-tool dropdown ms-3" v-if="$store.state.cart"><a class="navbar-tool-icon-box bg-dark dropdown-toggle" :href="carturl"><span class="navbar-tool-label">{{ $store.state.cart ? $store.state.cart.count : 0 }}</span><i class="navbar-tool-icon ci-cart"></i></a>
        <!-- Cart dropdown-->
